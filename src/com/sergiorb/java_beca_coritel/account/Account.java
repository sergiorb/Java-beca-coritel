...
public class Account {
	...
	// Subtracts desired quantity from account balance, if there is
	// enough money on it and the value is greater than 0.0€
	...
	public boolean subtractMoney(double quantity) {
		...
		if(getBalance() >= quantity) {
			...
			System.out.printf("There is not enough money in \"%s\"\n", getName());
			return false;
		}
	} // end subtractMoney
